...
class TestAnalyse(TestCase):
    ...
    def test_max_min_average_growth(self):
        datas = self.data.list_countries()
        ...
        self.assertNotEqual(self.data.average_growth([datas[8], datas[44], datas[20]], [1990, 1995]),
                            {datas[198]: 48861984.861827, datas[188]: 2521170662.67905, datas[205]: 215728296.915783})

        self.assertEqual(self.data.average_growth([datas[149], datas[188], datas[204]], [2001, 2006]),
 ...
 {'Lesotho': 2791762880.25884, 'Libya': 0, 'Luxembourg': 69487922619.3401}))
        ...
        self.assertEqual(self.data.average_gdp([datas[8], datas[44], datas[20]], [1990, 1995]),
                         {datas[8]: 1597122009.636872, datas[44]: 413608659.37108946, datas[20]: 5035726950.35461})

        self.assertNotEqual(self.data.average_gdp([datas[149], datas[188], datas[204]], [2001, 2006]),

   ...
   '''
    ...
    def production_growth(self, country_list, years):
        ...
        for country in country_list:
            for prod in self.F.list_products_country(country):
                ...
                production_dic[prod][1] += self.F.average_production([country], [years[0] - 5, years[0] - 1], prod)[
                    country]
    ...
    def av_gdp_growth_prod(self, countries_list, years_list, production_type):
        ...
        for country in countries_list:
            ...
            result_list[country] = ["average growth: " + str(list(self.average_growth([country], years_list).values())[0]),
                                    "average gdp: " + str(list(self.average_gdp([country], years_list).values())[0]),
                                    "average production: " + str(list(
                                        f.average_production([country], years_list, production_type, "Food").values())[
                                                                     0])]
